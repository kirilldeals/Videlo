    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoFeedbacks", x => new { x.VideoId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoCommentFeedbacks", x => new { x.CommentId, x.UserId });
                    table.ForeignKey(
                        name: "FK_VideoCommentFeedbacks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VideoCommentFeedbacks_VideoComments_CommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoCommentFeedbacks_UserId",
                table: "VideoCommentFeedbacks",
                column: "UserId");
